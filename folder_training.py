...
class FolderTrainer:
    ...
    def scan_training_folder(base_path: str, 
        ...
        try:
            ...
            raise ValueError(f"Permission denied accessing folder: {base_path}")
        ...
        for person_dir in subdirs:
            ...
            if images:
                ...
                existing_key = None
                for key in person_to_images.keys():
    ...
    def validate_folder_structure(base_path: str, 
                                  file_extensions: Optional[List[str]] = None) -> Tuple[bool, str, Dict]:
        """
    ...
    @staticmethod
    def get_folder_stats(base_path: str, file_extensions: Optional[List[str]] = None) -> Dict:
        """
