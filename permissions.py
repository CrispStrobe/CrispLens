...
class PermissionManager:
    ...
    def create_user(self, username: str, password: str, role: str,
                    allowed_folders: list[str]) -> tuple[bool, str, int | None]:
        """
    ...
    def authenticate(self, username: str, password: str) -> tuple[bool, str, User | None]:
        """
    ...
    def update_user(self, user_id: int, role: str | None = None,
                    ...
                    allowed_folders: list[str] | None = None) -> tuple[bool, str]:
